<header>
    ...
    <li class="dropdown">
      <a href="product_categories.php">Products</a>
    ...
    <li><a href="contact.php">Contact</a></li>
      ...
      <div>
        <a href="./login/signin.php" class="cart-button">
          <span id="cartCount">0</span> <i class="fas fa-shopping-cart"></i> 
        </a>
        <a href="./login/signin.php" class="login-link">Sign in</a>
      </div>
